              ...
              <div className="relative z-10">
                ...
                <div className="space-y-4 text-foreground/80">
                  <p>
                    ...
                    creating immersive digital experiences. Currently working at{" "}
                  ...
                  <p>
                    ...
                    TypeScript, and 3D web experiences. I love bringing designs
                    to life with smooth animations and interactive elements.
                  </p>
                </div>
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  {[
                    ...
                    <motion.span
                      ...
                      whileHover={{
                        scale: 1.1,
                        backgroundColor: "hsl(var(--neon-purple) / 0.3)",
                      }}
                    >
                      {tech}
                    </motion.span>
