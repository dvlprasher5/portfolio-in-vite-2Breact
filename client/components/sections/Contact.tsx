...
function ContactSphere({ position, color }: { position: [number, number, number], color: string }) {
  return (
...
function ContactTorus({ position, color }: { position: [number, number, number], color: string }) {
  return (
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <motion.button
                      ...
                      whileHover={{ scale: 1.02, boxShadow: '0 0 30px hsl(var(--neon-purple))' }}
                      whileTap={{ scale: 0.98 }}
                    >
                      {isSubmitting ? (
          ...
          >
            <div className="glass-effect p-8 rounded-2xl border border-neon-cyan/30">
              ...
              <p className="text-foreground/70 mb-8">
                ...
                Whether you're a company looking for a developer or another developer wanting to 
                ...
                {contactInfo.map((info, index) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-sm text-foreground/60">{info.value}</div>
                    </div>
                  </motion.a>
                ))}
              </div>
