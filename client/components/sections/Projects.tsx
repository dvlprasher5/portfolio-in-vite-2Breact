...
const projects = [
  {
    ...
    description: 'Modern e-commerce solution with 3D product visualization, built with React, TypeScript, and Three.js',
  ...
  },
  {
    ...
    description: 'Real-time analytics dashboard with animated charts and 3D data visualization for SATA Technologies',
  ...
  },
  {
    ...
    description: 'Immersive 3D portfolio showcasing creative web development with smooth animations',
  ...
  },
  {
    ...
    description: 'Secure mobile banking interface with biometric authentication and real-time transactions',
  ...
  },
  {
    ...
    description: 'Intelligent chatbot interface with natural language processing and voice recognition',
    technologies: ['Next.js', 'OpenAI API', 'WebRTC', 'Socket.io', 'TensorFlow'],
    image: '/api/placeholder/600/400',
    liveUrl: '#',
    githubUrl: '#',
  ...
  },
  {
    id: 6,
    title: 'VR Experience',
    description: 'Virtual reality web experience for architectural visualization using WebXR',
...
const categories = ['All', 'Web Application', 'Dashboard', 'Portfolio', 'Mobile App', 'AI Application', 'VR/AR'];

function ProjectCube({ color, position }: { color: string, position: [number, number, number] }) {
  return (
                  ...
                  >
                    <div className="absolute bottom-4 left-4 right-4 flex gap-3">
                      ...
                      <motion.a
                        ...
                        whileHover={{ scale: 1.05, backgroundColor: 'hsl(var(--neon-cyan))', color: 'hsl(var(--background))' }}
                        whileTap={{ scale: 0.95 }}
                      >
                        GitHub
                      </motion.a>
                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <motion.div
                      ...
                      animate={{ 
                        ...
                        opacity: hoveredProject === project.id ? [1, 0.7, 1] : 1
                      }}
